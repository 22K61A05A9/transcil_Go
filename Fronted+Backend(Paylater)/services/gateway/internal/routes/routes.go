...
func SetupRoutes(router *gin.Engine, cfg config.Config) {
	...
	// Public self-registration (before parameterized /merchants/:id).
	router.POST("/merchants/register", merchant)
	// Public catalog for purchase UI (before parameterized /merchants/:id).
	router.GET("/merchants/available", merchant)
