...
SELECT id, user_name, email, password, credit_limit, current_due FROM users WHERE current_due > 0 ORDER BY current_due DESC
`
...
SELECT id, user_name, email, password, credit_limit, current_due FROM users WHERE current_due >= credit_limit
`
