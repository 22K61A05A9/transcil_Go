...
func (q *Queries) CreateMerchant(ctx context.Context, arg CreateMerchantParams) error {
	_, err := q.db.ExecContext(ctx, createMerchant, arg.MerchantName, arg.PhoneNumber, arg.CommissionPercentage)
	return err
}
...
select id, merchant_name, phone_number, commission_percentage from merchants
`
...
select id, merchant_name, phone_number, commission_percentage from merchants where id = ?
`
